...
class Tokenizer:
    ...
    def subgraph_to_idx(self, subgraph):
        if subgraph not in self.subgraph2idx:
            return -100
...
def parse():
    ...
    parser.add_argument('--data', type=str, required=False, help='Path to molecule corpus')
    parser.add_argument('--vocab_size', type=int, default=500, help='Length of vocab')
    parser.add_argument('--output', type=str, default='/data00/jiahao/mole_supervise/ps/zinc250_table_size300.txt', help='Path to save vocab')

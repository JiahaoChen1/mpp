...
def scaffold_split(dataset, smiles_list, task_idx=None, null_value=0,
    ...
    if not return_smiles:
        ...
        train_smiles = [smiles_list[i][1] + '\n' for i in train_idx]
        valid_smiles = [smiles_list[i][1] + '\n' for i in valid_idx]
        test_smiles = [smiles_list[i][1] + '\n' for i in test_idx]
        # scaffolds = [s + '\n' for s in list(all_scaffolds.keys())]
        # return train_dataset, valid_dataset, test_dataset, scaffolds
...
def random_scaffold_split(dataset, smiles_list, task_idx=None, null_value=0,
    ...
    # indices = [i for i in range(len(list(scaffolds.values())))]
    # indices = rng.permutation(indices)
    # scaffold_sets = list(scaffolds.values())[indices]

    scaffold_sets = np.array(list(scaffolds.values()), dtype="object")
    scaffold_sets = rng.permutation(scaffold_sets)
    ...
    # for i in indices:
    #     scaffold_set = list(scaffolds.values())[i]
